...
struct Matrix(T, size_t dim_)
    if (is(T == real) || is(T == double) || is(T == float) && ((dim_ >= 2) && (dim_ <= 4))) {
   ...
   */
  void opIndexAssign(K)(K c, size_t row, size_t col) if (is(K : real)) {
    this.col[col][row] = c;
  }
   ...
   */
  void opIndexAssign(K)(K v, size_t j) if (isVector!(K)) {
   ...
   */
  @safe private pure nothrow size_t pos(size_t i, size_t j) const {
    return i + offset(j);
  }
  ...
  */
  Matrix opBinary(string op)(in real rhs) const if (op == "*" || op == "/") {
  ...
  */
  Matrix opBinary(string op)(auto ref const Matrix rhs) const if (op == "*") {
    Matrix mat;
  ...
  */
  VCol opBinary(string op)(auto ref const VCol rhs) const if (op == "*") {
  ...
  */
  VCol opBinaryRight(string op)(auto ref const VCol lhs) const if (op == "*") {
  ...
  */
  pure T determinant() const {
    static if (dim == 2) {
      ...
      return (cell[pos(0, 0)] * cell[pos(1, 1)] - cell[pos(0, 1)] * cell[pos(1, 0)]) * (cell[pos(2,
            2)] * cell[pos(3, 3)] - cell[pos(2, 3)] * cell[pos(3, 2)]) - (cell[pos(0,
            0)] * cell[pos(1, 2)] - cell[pos(0, 2)] * cell[pos(1, 0)]) * (cell[pos(2,
            1)] * cell[pos(3, 3)] - cell[pos(2, 3)] * cell[pos(3, 1)]) + (cell[pos(0,
            0)] * cell[pos(1, 3)] - cell[pos(0, 3)] * cell[pos(1, 0)]) * (cell[pos(2,
            1)] * cell[pos(3, 2)] - cell[pos(2, 2)] * cell[pos(3, 1)]) + (cell[pos(0,
            1)] * cell[pos(1, 2)] - cell[pos(0, 2)] * cell[pos(1, 1)]) * (cell[pos(2,
            0)] * cell[pos(3, 3)] - cell[pos(2, 3)] * cell[pos(3, 0)]) - (cell[pos(0,
            1)] * cell[pos(1, 3)] - cell[pos(0, 3)] * cell[pos(1, 1)]) * (cell[pos(2,
            0)] * cell[pos(3, 2)] - cell[pos(2, 2)] * cell[pos(3, 0)]) + (cell[pos(0,
            2)] * cell[pos(1, 3)] - cell[pos(0, 3)] * cell[pos(1, 2)]) * (cell[pos(2,
            0)] * cell[pos(3, 1)] - cell[pos(2, 1)] * cell[pos(3, 0)]);
    }
  }
  ...
  */
  Matrix inverse() const {
    ...
    static if (dim == 2) {
      ...
      mat[0, 0] = this[1, 1] * (this[2, 2] * this[3, 3] - this[2, 3] * this[3, 2]) + this[1,
        2] * (this[2, 3] * this[3, 1] - this[2, 1] * this[3, 3]) + this[1,
        3] * (this[2, 1] * this[3, 2] - this[2, 2] * this[3, 1]);
      mat[0, 1] = this[2, 1] * (this[0, 2] * this[3, 3] - this[0, 3] * this[3, 2]) + this[2,
        2] * (this[0, 3] * this[3, 1] - this[0, 1] * this[3, 3]) + this[2,
        3] * (this[0, 1] * this[3, 2] - this[0, 2] * this[3, 1]);
      mat[0, 2] = this[3, 1] * (this[0, 2] * this[1, 3] - this[0, 3] * this[1, 2]) + this[3,
        2] * (this[0, 3] * this[1, 1] - this[0, 1] * this[1, 3]) + this[3,
        3] * (this[0, 1] * this[1, 2] - this[0, 2] * this[1, 1]);
      mat[0, 3] = this[0, 1] * (this[1, 3] * this[2, 2] - this[1, 2] * this[2, 3]) + this[0,
        2] * (this[1, 1] * this[2, 3] - this[1, 3] * this[2, 1]) + this[0,
        3] * (this[1, 2] * this[2, 1] - this[1, 1] * this[2, 2]);

      mat[1, 0] = this[1, 2] * (this[2, 0] * this[3, 3] - this[2, 3] * this[3, 0]) + this[1,
        3] * (this[2, 2] * this[3, 0] - this[2, 0] * this[3, 2]) + this[1,
        0] * (this[2, 3] * this[3, 2] - this[2, 2] * this[3, 3]);
      mat[1, 1] = this[2, 2] * (this[0, 0] * this[3, 3] - this[0, 3] * this[3, 0]) + this[2,
        3] * (this[0, 2] * this[3, 0] - this[0, 0] * this[3, 2]) + this[2,
        0] * (this[0, 3] * this[3, 2] - this[0, 2] * this[3, 3]);
      mat[1, 2] = this[3, 2] * (this[0, 0] * this[1, 3] - this[0, 3] * this[1, 0]) + this[3,
        3] * (this[0, 2] * this[1, 0] - this[0, 0] * this[1, 2]) + this[3,
        0] * (this[0, 3] * this[1, 2] - this[0, 2] * this[1, 3]);
      mat[1, 3] = this[0, 2] * (this[1, 3] * this[2, 0] - this[1, 0] * this[2, 3]) + this[0,
        3] * (this[1, 0] * this[2, 2] - this[1, 2] * this[2, 0]) + this[0,
        0] * (this[1, 2] * this[2, 3] - this[1, 3] * this[2, 2]);

      mat[2, 0] = this[1, 3] * (this[2, 0] * this[3, 1] - this[2, 1] * this[3, 0]) + this[1,
        0] * (this[2, 1] * this[3, 3] - this[2, 3] * this[3, 1]) + this[1,
        1] * (this[2, 3] * this[3, 0] - this[2, 0] * this[3, 3]);
      mat[2, 1] = this[2, 3] * (this[0, 0] * this[3, 1] - this[0, 1] * this[3, 0]) + this[2,
        0] * (this[0, 1] * this[3, 3] - this[0, 3] * this[3, 1]) + this[2,
        1] * (this[0, 3] * this[3, 0] - this[0, 0] * this[3, 3]);
      mat[2, 2] = this[3, 3] * (this[0, 0] * this[1, 1] - this[0, 1] * this[1, 0]) + this[3,
        0] * (this[0, 1] * this[1, 3] - this[0, 3] * this[1, 1]) + this[3,
        1] * (this[0, 3] * this[1, 0] - this[0, 0] * this[1, 3]);
      mat[2, 3] = this[0, 3] * (this[1, 1] * this[2, 0] - this[1, 0] * this[2, 1]) + this[0,
        0] * (this[1, 3] * this[2, 1] - this[1, 1] * this[2, 3]) + this[0,
        1] * (this[1, 0] * this[2, 3] - this[1, 3] * this[2, 0]);

      mat[3, 0] = this[1, 0] * (this[2, 2] * this[3, 1] - this[2, 1] * this[3, 2]) + this[1,
        1] * (this[2, 0] * this[3, 2] - this[2, 2] * this[3, 0]) + this[1,
        2] * (this[2, 1] * this[3, 0] - this[2, 0] * this[3, 1]);
      mat[3, 1] = this[2, 0] * (this[0, 2] * this[3, 1] - this[0, 1] * this[3, 2]) + this[2,
        1] * (this[0, 0] * this[3, 2] - this[0, 2] * this[3, 0]) + this[2,
        2] * (this[0, 1] * this[3, 0] - this[0, 0] * this[3, 1]);
      mat[3, 2] = this[3, 0] * (this[0, 2] * this[1, 1] - this[0, 1] * this[1, 2]) + this[3,
        1] * (this[0, 0] * this[1, 2] - this[0, 2] * this[1, 0]) + this[3,
        2] * (this[0, 1] * this[1, 0] - this[0, 0] * this[1, 1]);
      mat[3, 3] = this[0, 0] * (this[1, 1] * this[2, 2] - this[1, 2] * this[2, 1]) + this[0,
        1] * (this[1, 2] * this[2, 0] - this[1, 0] * this[2, 2]) + this[0,
        2] * (this[1, 0] * this[2, 1] - this[1, 1] * this[2, 0]);
    }
